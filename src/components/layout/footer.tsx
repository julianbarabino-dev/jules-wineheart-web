...
import { Instagram, Youtube, Music, Download, Mail } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 max-w-[1080px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
                ...
                <div className="md:col-span-1">
                    <h4 className="text-xl font-black text-white uppercase italic tracking-tighter mb-6">JW.CVR</h4>
                ...
                {/* Columna 3: Redes */}
                <div className="md:col-span-1">
                    <h5 className="text-xs font-bold text-white uppercase tracking-widest mb-6">Conectar</h5>
