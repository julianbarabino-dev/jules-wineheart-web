    ...
    <footer className="bg-background/50 pt-20 pb-10 border-t border-border/50 relative z-10">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-border pt-12">
          <div>
            <h4 className="font-bold text-foreground mb-4 uppercase text-xs tracking-wider">{dictionary.contact.title}</h4>
            ...
            <p className="text-muted-foreground/50 text-xs font-code">{dictionary.contact.location}</p>
            <a href="#" className="mt-4 inline-block text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-all border-b border-border hover:border-foreground pb-0.5">
              {dictionary.contact.epk}
            </a>
          </div>
          <div>
            <h4 className="font-bold text-foreground mb-4 uppercase text-xs tracking-wider">{dictionary.social.title}</h4>
          ...
          <div className="md:text-right flex flex-col md:items-end justify-between">
            ...
            <p className="text-muted-foreground/50 text-[10px] mt-2 cursor-default hover:text-muted-foreground transition-colors">{dictionary.credits}</p>
          </div>
        </div>
      </div>
    </footer>
